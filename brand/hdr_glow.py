...
VENDORED, UNMODIFIED (apart from this note), from tatarco/hdr-glow-logo, MIT
licensed -- see LICENSE-hdr-glow-logo alongside this file. Copied in rather
than installed so the brand pipeline keeps working offline and produces the
same bytes a year from now. Upstream: https://github.com/tatarco/hdr-glow-logo
